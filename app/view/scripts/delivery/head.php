...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-44721091-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-44721091-2');
</script>
<div id="prod_added">
			...
			<div class="col-xs-12">
				<ul class="list-inline pull-right">
					<? if (Model_User::userid()) { ?>
						<li><a href="<?= $this->url->mk("/user") ?>" id="login_link" onclick=""><?= $this->labels["welcome"] ?>, <?= $_SESSION["username"] ?></a></li><li><a href="/user/wishlist">Список желаний</a></li><li><a href="/login/logoff">Выход</a></li>
					<? } else { ?>
					<li>
						<div class="dropdown">
						...
						<li>
							<div class="dropdown">
								<button class="btn dropdown-toggle" type="button" id="dropdownRegister" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
