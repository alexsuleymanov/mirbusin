...
//		return $str;
	...
	<g:price>".$prod->price." UAH</g:price>";
			if ($skidka->value) {		
	echo "\n	<g:sale_price>".($prod->price * (100 - $skidka->value) / 100)." UAH</g:sale_price>
...
//			$prodchars = array();
	...
	<barcode>"."В упаковке ".$prod->inpack."</barcode>
...
//			die();
		...
		if($args[2] != 'admin'){
			...
			echo "http://mirbusin.ru/partners.xml обновлен!<br />";
		}
	}